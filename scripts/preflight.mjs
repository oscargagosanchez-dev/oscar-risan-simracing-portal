...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');const app=fs.readFileSync(path.join(root,'app.js'),'utf8');const css=fs.readFileSync(path.join(root,'styles.css'),'utf8');const srp=fs.readFileSync(path.join(root,'srp.css'),'utf8');const osp=fs.readFileSync(path.join(root,'osp.css'),'utf8');
