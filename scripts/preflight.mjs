...
for(const needle of ['or-favorite-sims-v1','/buscar.html','favoritePanel','og:image','application/ld+json']){if(!pnext.includes(needle)){console.error('Portal next missing',needle);failed=true}}
