...
const required=['index.html', 'styles.css', 'app.js', 'vercel.json', 'api/events.js', 'api/youtube.js', 'api/health.js', 'img-spa-lmp2-lmgt3.js', 'img-spa-wet-multiclass.js', 'img-lemans-hypercar-lmgt3.js', 'img-monza-gt3.js', 'img-nurburgring-dtm.js', 'img-hockenheim-super-touring.js', 'img-silverstone-roadster.js', 'img-suzuka-gt.js'];
let failed=false;
